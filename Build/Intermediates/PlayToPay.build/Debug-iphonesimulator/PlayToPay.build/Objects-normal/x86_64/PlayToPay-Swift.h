...
@property (nonatomic, strong) NSTimer * __nonnull countdownTimer;
@property (nonatomic, strong) UILabel * __null_unspecified countdownTimerLabel;
- (void)setupCountdown;
...
SWIFT_CLASS("_TtC9PlayToPay26ControlPanelViewController")
...
@property (nonatomic, strong) IBOutlet UILabel * __null_unspecified scoreLabel;
@property (nonatomic, strong) IBOutlet UILabel * __null_unspecified timerLabel;
@property (nonatomic, copy) IBOutletCollection(UIView) NSArray<UIView *> * __null_unspecified buttonViews;
- (void)viewDidLoad;
@property (nonatomic) NSInteger timeLeft;
@property (nonatomic, strong) NSTimer * __nonnull countdownTimer;
@property (nonatomic, strong) UILabel * __null_unspecified countdownTimerLabel;
...
- (float)randomCGFloat;
- (void)subtractTime;
- (void)buttonHit:(UIButton * __null_unspecified)sender;
- (void)segueToResults;
- (void)prepareForSegue:(UIStoryboardSegue * __nonnull)segue sender:(id __nullable)sender;
- (nonnull instancetype)initWithNibName:(NSString * __nullable)nibNameOrNil bundle:(NSBundle * __nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, strong) L360ConfettiArea * __null_unspecified confettiArea;
@property (nonatomic, strong) HTPressableButton * __null_unspecified playAgainButton;
@property (nonatomic, strong) HTPressableButton * __null_unspecified venmoButton;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified loserLabel;
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
@property (nonatomic, strong) AVAudioPlayer * __null_unspecified avPlayer;
- (void)playHorn;
...
@property (nonatomic, weak) IBOutlet UIView * __null_unspecified rapidFireView;
@property (nonatomic, weak) IBOutlet UIView * __null_unspecified bustItView;
@property (nonatomic, weak) IBOutlet UIView * __null_unspecified controlPanelView;
@property (nonatomic, weak) IBOutlet UIView * __null_unspecified switchUpView;
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified randomButton;
- (void)viewDidLoad;
- (IBAction)rapidFireSelected:(id __nonnull)sender;
- (IBAction)bustItSelected:(id __nonnull)sender;
- (IBAction)controlPanelSelected:(id __nonnull)sender;
- (IBAction)switchUpSelected:(id __nonnull)sender;
- (IBAction)toRandomSelection:(id __nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * __nullable)nibNameOrNil bundle:(NSBundle * __nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, strong) HTPressableButton * __null_unspecified commenceButton;
@property (nonatomic, strong) HTPressableButton * __null_unspecified plusButton;
@property (nonatomic, strong) HTPressableButton * __null_unspecified minusButton;
@property (nonatomic, strong) L360ConfettiArea * __null_unspecified confettiArea;
...
@property (nonatomic, strong) HTPressableButton * __null_unspecified playButton;
...
SWIFT_CLASS("_TtC9PlayToPay33RandomGameSelectionViewController")
@interface RandomGameSelectionViewController : UIViewController <POPAnimationDelegate>
@property (nonatomic, readonly, copy) NSArray<NSString *> * __nonnull buttonTitles;
@property (nonatomic, strong) HTPressableButton * __null_unspecified continueButton;
